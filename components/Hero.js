        ...
        <Row className="align-items-center">
          <Col lg={6}>
            <div className="pr-lg-5">
              ...
              <h1 className="text-dark mb-4 font-weight-normal line-height-1_4">The future of cannabis consumption is <span className="important-text font-weight-medium">coming soon...</span></h1>
